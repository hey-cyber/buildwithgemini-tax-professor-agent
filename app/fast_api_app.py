...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    # Runner for the A2A path, sharing the same session/memory/artifact services as the
...
app.title = "tax-professor-agent"
app.description = "API for interacting with the Corporate Tax Professor Agent"
